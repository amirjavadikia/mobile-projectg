  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <View style={styles.container}>
        ...
        <View style={[styles.box, { backgroundColor: applyChanges ? newBackgroundColor : '#dde30f', borderRadius: applyChanges ? parseInt(newBorderRadius) || 0 : 8, borderWidth: applyChanges ? parseInt(newBorderWidth) || 1 : 1, borderColor: applyChanges ? newBorderColor : "#111" }]}>
