...
const styles = StyleSheet.create({
  ...
  box: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: applyChanges ? newBackgroundColor : '#fff', borderRadius: applyChanges ? parseInt(newBorderRadius) || 0 : 0, borderWidth: applyChanges ? parseInt(newBorderWidth) || 1 : 1, borderColor: applyChanges ? newBorderColor : "#111"
  },
  boxText: {
