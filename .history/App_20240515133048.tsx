...
const App = () => {
  ...
  const handleTextColorChange = (inputText: string) => {
    setNewTextColor(inputText);
    setApplyChanges(false); 
  };

  const handleBackgroundChange = (inputText: string) => {
    setNewBackgroundColor(inputText);
    setApplyChanges(false); 
  };

  const handleBorderColorChange = (inputText: string) => {
    setNewBorderColor(inputText);
    setApplyChanges(false); 
  };

  const handleBorderWidthChange = (inputText: integer) => {
