  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <View style={styles.container}>
        ...
        <View style={[styles.box, { backgroundColor: newBackgroundColor, borderRadius: parseInt(newBorderRadius) || 0, borderWidth: parseInt(newBorderWidth) || 0, borderColor: (newBordercolor) || 0  }]}>
          <Text>{text}</Text>
        </View>
      </View>
    </ScrollView>
